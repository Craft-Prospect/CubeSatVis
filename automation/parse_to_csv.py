...
data = np.load(os.path.join("data", 'save_data_qkd.npy'))
...
new_df.to_csv("data/target_info.csv")
fixed_df.to_csv("data/fixed_data.csv")
corners_df.to_csv("data/map_corners.csv")